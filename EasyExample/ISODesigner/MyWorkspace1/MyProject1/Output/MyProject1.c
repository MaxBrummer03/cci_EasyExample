...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 11, 0, 
		...
		XYREF(Button_Minus, 175, 418),
		XYREF(InputNumber_Tagesziel, 10, 410),
		XYREF(InputNumber_Gesamtziel, 180, 175),
		XYREF(OutputString_11009, 10, 173),
	...
	ID(SoftKey_Minus), TYPEID_SOFTKEY, COLOR(254), 1, 1, 0, 
		XYREF(OutputString_11008, 1, 1),
	ID(Button_PlusPlus), TYPEID_BUTTON, WORD(154), WORD(88), 187, 144, 1, 0, 1, 0, 
		XYREF(OutputString_PlusPlus, 30, 20),
	ID(Button_Minus), TYPEID_BUTTON, WORD(136), WORD(47), 249, 249, 1, 0, 1, 0, 
		XYREF(OutputString_11006, 34, 7),
	...
	ID(Button_6004), TYPEID_BUTTON, WORD(58), WORD(18), 249, 249, 1, 0, 1, 0, 
		XYREF(OutputString_11007, -4, -5),
	ID(InputNumber_Tagesziel), TYPEID_INNUM, WORD(130), WORD(49), COLOR_WHITE, ID(FontAttributes_Default), 0, 
		ID(NumberVariable_Tagesziel), LONG(123UL), LONG(0UL), LONG(65535UL), LONG(0L), FLOAT_1, 0, 0, 2, 1, 0, 
	ID(InputNumber_Gesamtziel), TYPEID_INNUM, WORD(109), WORD(45), COLOR_WHITE, ID(FontAttributes_Default), 0, 
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(80), WORD(40), COLOR_WHITE, ID(FontAttributes_Button), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_11006), TYPEID_OUTSTR, WORD(47), WORD(23), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 1, WORD(4), '-', ' ', ' ', ' ', 0,
	ID(OutputString_11007), TYPEID_OUTSTR, WORD(182), WORD(148), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 1, WORD(6), 'B', 'u', 't', 't', 'o', 'n', 0,
	ID(OutputString_11008), TYPEID_OUTSTR, WORD(79), WORD(76), COLOR_OLIVE, ID(FontAttributes_Default), 0,
		ID(ID_NULL), 0, WORD(5), 'M', 'i', 'n', 'u', 's', 0,
	ID(OutputString_11009), TYPEID_OUTSTR, WORD(151), WORD(53), COLOR_WHITE, ID(FontAttributes_Default), 0,
		ID(ID_NULL), 0, WORD(10), 'G', 'e', 's', 'a', 'm', 't', 'z', 'i', 'e', 'l', 0,
	...
	ID(AuxFunction2_29001), TYPEID_AUXFUNC2, COLOR_WHITE, 128, 0, 
}; // isoOP_MyProject1
